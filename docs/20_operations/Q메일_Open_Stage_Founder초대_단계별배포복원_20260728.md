...
> 현재 단계: RP-1 설치·검증 `PASS` 완료 · RP-2 파일 작성 완료·사전점검 대기
...
| RP-2A | 서대원 Seed·기가입회원 사전점검 | 대상 수·회원원장 지문 확인 |
| RP-2B | Seed·기가입회원 스냅샷·개인 링크 | 기존 데이터 무변경 확인 |
| RP-2C | 3~5계정 자동롤백 파일럿 | 귀속·장부 제약·영구 증가 0 |
| RP-3 | 가입 API 자동 장부 연결 | 실가입과 수동 대조 |
...
- 사전점검 확인 전 서대원 Seed·기가입회원 스냅샷 SQL 실행
- 실회원 대상 캠페인 링크 발송
- 10명·5명 조건 외부 공지
...
RP-1은 완료되었다. 대표님은 RP-2의 서대원 Seed·기가입회원 스냅샷·개인 링크·3~5계정 자동롤백 파일럿 변경안을 승인했다. 실제 초대 발송과 가입 API 자동 장부 연결은 RP-3 별도 승인 전까지 시작하지 않는다.
